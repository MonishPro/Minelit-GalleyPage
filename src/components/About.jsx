        ...
        <>
            <div className="container-about">
                <div className="rectangle">
                    <h1 className="about-door">DOOR VERSE</h1>
